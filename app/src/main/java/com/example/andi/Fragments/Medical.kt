...
import com.example.andi.databinding.FragmentMedicalBinding
...
class Medical : Fragment() {
    lateinit var bind: FragmentMedicalBinding
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_medical,container,false)
