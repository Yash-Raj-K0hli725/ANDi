...
import com.example.andi.databinding.FragmentToursTravelsBinding
import com.example.andi.viewModel.mainModel


class toursTravels : Fragment() {
    lateinit var bind: FragmentToursTravelsBinding
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_tours_travels,container,false)
    ...
    fun filterPage(pageData:List<htmlData>){
        ...
        pageData.forEach {
            when(it.sector){
                "Sector - Tours & Travels"->idk.add(it)
            }
        }
