...
import com.example.andi.databinding.FragmentRecruitmentBinding
import com.example.andi.viewModel.mainModel


class Recruitment : Fragment() {
    lateinit var bind: FragmentRecruitmentBinding
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_recruitment,container,false)
