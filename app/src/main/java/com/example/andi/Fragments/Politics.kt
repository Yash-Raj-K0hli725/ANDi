...
class Politics : Fragment() {
    lateinit var bind: FragmentPoliticsBinding
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_politics,container,false)
