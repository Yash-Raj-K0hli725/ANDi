...
import com.example.andi.databinding.FragmentEducationBinding
import com.example.andi.viewModel.mainModel

class Education : Fragment() {
    lateinit var bind: FragmentEducationBinding
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_education,container,false)
