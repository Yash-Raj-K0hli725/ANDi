...
import com.example.andi.databinding.FragmentFoodBinding
...
class Food : Fragment() {
    ...
    override fun onCreateView(
        ...
        bind = DataBindingUtil.inflate(inflater,R.layout.fragment_food,container,false)
